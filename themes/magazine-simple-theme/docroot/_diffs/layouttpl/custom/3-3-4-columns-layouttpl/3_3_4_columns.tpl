<div class="columns-3-3-4" id="main-content" role="main">
		...
		<table class="portlet-layout" id="footer-content">
		<tr>
			<td class="aui-w25 portlet-column portlet-column-first" id="column-7">
				$processor.processColumn("column-7", "portlet-column-content portlet-column-content-first")
			</td>

			<td class="aui-w25 portlet-column" id="column-8">
				$processor.processColumn("column-8", "portlet-column-content")
			</td>

			<td class="aui-w25 portlet-column" id="column-9">
				$processor.processColumn("column-9", "portlet-column-content")
			</td>

			<td class="aui-w25 portlet-column portlet-column-last" id="column-10">
		...
		<div class="portlet-layout" id="footer-content">
